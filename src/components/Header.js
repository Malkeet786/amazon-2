...
function Header(){
    ...
    const items=useSelector(selectItems);//use to increase number in the basket
    ...
    return(
        ...
        <div className="flex items-center space-x-3 p-2 pl-6 bg-amazon_blue-light text-white text-sm">
            ...
            <p className="link hidden lg:inline-flex">Shopkepper Toolkit</p>
            <p className="link hidden lg:inline-flex">Health & Personal Cars</p>
        </div>
        </header>
    )
}
